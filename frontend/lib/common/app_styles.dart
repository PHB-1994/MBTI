...
/*
일반적인 웹 디자인에서 사용하는 색삭코드
          검정                            하얀색
rgb(255, 255, 255, 0.1) 엄청 투명함,  rgba(0, 0, 0, 0.9) 불투명도 90%
hex = #000000           투명도 없음   hex = #ffffff      투명도 없음

플러터에서 색상을 표기하는 방법
방법 1 : hex 색상에 OxFF 붙이기. 가장 일반적으로 많이 사용
0xFF : 불투명도
Color(0xFF64BF6)
        0xFF      64B5F6
     완전 보이게   hex 색상 표기
...
방법 3 : fromRGBO = rgb, rgba 와 비슷한 형태
...
class AppColors {
  ...
  static const Color primaryDart = Color(0xFF1976D2);
