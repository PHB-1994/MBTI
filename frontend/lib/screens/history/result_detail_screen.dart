...
class ResultDetailScreen extends StatefulWidget {
  ...
  @override // 화면 상태와 화면에서 상태 변경을 위한 위젯을 구분하여 만든 후, 사용
...
class _ResultDetailScreenState extends State<ResultDetailScreen> {
  ...
  @override // 기본적으로 초기 상태를 생성하며, 추가적으로 호출할 기능도 함께 작성하기 위해 재사용
  void initState() {
    super.initState();
    loadResults();
  }
  ...
  void loadResults() async { // ResultDetailScreen extends StatefulWidget 선언한 userName
    ...
    try{
      ...
      setState(() {
        // results = 전역변수로 Widget build 에 접근할 수 있는 변수 공간
        results = data;
        isLoading = false;
      });
          ...
          itemBuilder: (context, index) {
            ...
            return Card(
              child: ListTile(
                ...
                // 클릭하면 보인다는 아이콘 형태의 모형
                trailing: Icon(Icons.arrow_forward_ios),
                // 한 줄의 어떤 곳을 클릭하더라도 세부 정보를 확인할 수 있는 모달창 띄우기
                // 예약 세부 내용이 담긴 모달창
