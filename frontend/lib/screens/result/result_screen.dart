...
// statelessWidget 으로 작성 가능하다.
// SingleChildScrollView -> 화면은 움직이는 화면이기 때문에 less 사용 불가

// 과제 : 로딩중 화면 메세지 없이 import 하여 개발자가 원하는 본인 방식대로 추가
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              * 모서리 둥글기 15
              * 실선 회색 300 계열
              * Column 은 crossAxiosAlignment start 로 주기
              *
              ...
              * */
               ...
               */
                child: ElevatedButton.icon( // 생성자가 onPressed icon label required 나머지는 필수로 작성하지 안하도 되는 생성자
